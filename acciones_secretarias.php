                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6 ">
                                <p> Realizamos una gestión enfocada en dos aristas: responder en tiempo y
                                    forma, y con calidad, las consultas de las entidades asociadas sobre temas
                                    presupuestarios.
                                    Asimismo, seguir generando mecanismos para dar cada vez mayor transparencia a la
                                    distribución
                                    de los fondos destinados al fortalecimiento institucional y la capacitación de
                                    nuestras asociadas.
                                </p>
                            </div>
                            <div class="col-sm-12 col-md-6">
                                <p> Confeccionamos y enviamos una encuesta de satisfacción a las entidades a las que se
                                    brinda apoyo,
                                    logrando un 76 % de respuestas y un resultado promedio de 9 entre los ítems:
                                    Velocidad de respuesta a solicitudes
                                    (puntaje 8.93), Atención del personal (puntaje 9.11) y Calidad del servicio prestado
                                    (puntaje 9.022).
                                    También realizamos una encuesta interna a los directivos involucrados y el resultado
                                    fue un promedio
        ...
        <div class="content-wrap pb-0">
            <div class="container clearfix">
                ...
                <p>
                    ...
                    manteniendo la implementación de protocolos de prevención de COVID-19 y haciendo el seguimiento de
                    casos.
            ...
            <div class="container clearfix">
                ...
                <div class="col-12 mt-4 text-justify">
                    ...
                    <p>
                        ...
                        Afianzamos una red con 26 referentes de capacitación donde se encuentran representadas todas las
                        provincias y CABA.
                        Esto ayudó a cumplir con el plan de incrementar la plantilla de docentes regionales. De las 26
                        actividades presenciales dictadas,
                        el 100 % fue con docentes locales.</p>
                    <p>

                    <p>
                        A su vez, firmamos convenios con los ministerios de Desarrollo Social de las provincias de San
                        Luis y
                        Salta para capacitar en competencias que mejoren la empleabilidad de beneficiarios de esas
                        provincias.
            ...
            <div class="container clearfix">
                ...
                <div class="row">
                    <div class="col-md-6 text-justify">
                        ...
                        <p>Bajo la modalidad virtual, realizamos talleres preparatorios de Rondas de Negocios, en los
                            que participaron
                            las entidades organizadoras, los organismos acompañantes y los empresarios interesados en la
                            ronda convocante. </p>
                    ...
                    <div class="row clearfix align-items-stretch ">
                        ...
                        <div class="col-lg-4 col-md-4 dark center  p-4" style="background-color: #576F9E;">
                            <div class="align-items-center">
                                ...
                                <div class="counter counter-lined"><span data-from="10" data-to="96"
                                        data-refresh-interval="13" data-speed="3000">96</span>% </div>
                                <p class="bloque-bajada">de las pymes encuestadas indicaron que necesitan financiamiento
                                    para realizar inversiones. Con respecto a los obstáculos a la hora de
                                    solicitar financiamiento, el 59 % respondió que los requisitos para el acceso son
                                    demasiado exigentes.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 dark center  p-4" style="background-color: #627FA9;">
                            ...
                            <div class="counter counter-lined"><span data-from="1000" data-to="87"
                                    data-refresh-interval="10" data-speed="3000">87</span>%</div>
                            <p class="bloque-bajada">tiene entre 18 y 55 años y, además, el emprendimiento es su
                                actividad principal para el 73 %. Los principales obstáculos
                                a la hora de emprender, según el 65 % de los encuestados, es la falta de capital
                                inicial, siendo para el 58,6 % la incertidumbre por la coyuntura actual.
                            </p>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 dark center  p-4" style="background-color: #6C8FB4;">
                            ...
                            <div class="counter counter-lined"><span data-from="10" data-to="25"
                                    data-refresh-interval="2" data-speed="3000">25</span>%</div>
                            <p class="bloque-bajada">de las entidades encuestadas sostuvo que aumentó su base de socios.
                                En relación con cómo definen a sus socios,
                                respondieron que el 53 % de su base está conformada mayoritariamente por “pequeñas
                                empresas” y, el 20 %, por emprendedores.</p>
                        </div>
