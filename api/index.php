                ...
                <div class="vertical-middle slider-element-fade">
                    <div class="container text-center py-5">
                        <div class="emphasis-title mb-2">
                            <h3>
                                <div class="oc-item gradient-text gradient-red-yellow text-uppercase">Reporte de
                            ...
                            <div class="col-lg-4">
                                ...
                                <div id="oc-testi" class="owl-carousel testimonials-carousel carousel-widget mt-5"
                                    ...
                                    <div class="oc-item">
                                        <div class="testimonial border-0 shadow-none bg-transparent">
                                            <div class="testi-content">
                                                <p>Quickly redefine resource sucking web services after exceptional
                                                    customer service. Professionally coordinate focused platforms before
                                                    visionary architectures.</p>
                                                <div class="testi-meta d-flex align-items-center">
                                                    <img src="demos/freelancer/images/testi/face.jpg" alt="Face"
                                                        width="30">
                                                    <div>
                                                        John Doe
                                    ...
                                    <div class="oc-item">
                                        <div class="testimonial border-0 shadow-none bg-transparent">
                                            <div class="testi-content">
                                                <p>Dramatically mesh user friendly solutions whereas sticky human
                                                    capital. Assertively fashion impactful "outside the box".</p>
                                                <div class="testi-meta d-flex align-items-center">
                                    ...
                                    <div class="mt-auto">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center mb-4">
                                                <img src="demos/freelancer/images/icons/sketch.svg" height="50"
                                                    alt="Image">
                        ...
                        <div class="section rounded-10 p-6 my-4" style="background-color: #F1F1F1;">
                            <div class="row justify-content-between align-items-center col-mb-50">
                                ...
                                <div class="col-md-3 col-6 center"><img
                                        src="demos/freelancer/images/clients/netflix.svg" alt="Clients"></div>
                                ...
                                <div class="col-md-3 col-6 center"><img src="demos/freelancer/images/clients/slack.svg"
                                        alt="Clients"></div>
                                <div class="col-md-3 col-6 center"><img
                                        src="demos/freelancer/images/clients/applemusic.svg" alt="Clients"></div>
                            </div>
                        </div>
                    </div>
                </div>
