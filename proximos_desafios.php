                ...
                <div class="container clearfix">
                    ...
                    <div class="row  text-justify mt-4">
                        ...
                        <div class="col-12 mt-4">
                            ...
                            <p>
                                En 2023, continuaremos fortaleciendo la actividad de entidades, pymes y emprendedores
                                promoviendo el enfoque de Triple Impacto y el desarrollo sustentable del país. Para
                                hacerlo, definimos objetivos sectoriales que nos permiten orientar nuestras acciones y
                        ...
                        <div class="container clearfix">
                            <div class="row align-items-md-center mb-5">
                                <div class="col-md-6 col-sm-12 pl-sm-3 mt-3 mt-sm-0">
                                    ...
                                    <div class="card shadow-sm border-light mt-4">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p>Recertificar nuestro Sistema de Gestión de la Calidad bajo la Norma
                                                IRAM 9001:2015, con el objetivo de continuar fortaleciendo nuestro
                                                enfoque en los resultados de los procesos, la satisfacción de
                                    ...
                                    <div class="card shadow-sm border-light mt-4">
                                        <img src="images/logos/capacitacion@4x.png" alt="Capacitación"
                                            class="card-img-top">
                                        <div class="card-body">
                                            <h3 class="">Secretaría de Capacitación</h3>
                                            <p>Implementar una nueva plataforma de la Escuela de Negocios CAME.</p>
                                            <p>Afianzar una nueva propuesta de formación dirigencial.</p>
                                            <p>Desarrollar iniciativas de cápsulas de micro aprendizaje.</p>
                                            <p>Implementar proyectos educativos con el Ministerio de Trabajo.</p>
                                            <p>Realizar capacitaciones en oficios en convenio con diferentes organismos.
                                            </p>
                                    ...
                                    <div class="card shadow-sm border-light mt-4">
                                        ...
                                        <div class="card-body">
                                            <h3 class="">Comercio</h3>
                                            <p>Incorporar el sistema de gestión sustentable en la gestión cotidiana de
                                                por lo menos dos CCA.</p>
                                            <p>Consolidar el intercambio de conocimiento y experiencias de gestión
                                                sustentable en el comercio urbano entre dirigentes, empresarios y
                                                funcionarios de localidades y CCA.</p>
                                            <p>Incorporar proyectos específicos de movilidad sostenible (bicisendas),
                                                separación de residuos, entre otros, en CCA existentes.</p>
                                            <p>Reforzar acciones de sensibilización para dirigentes de entidades y
                                                protagonistas de CCA acerca de la incorporación de estrategias de Triple
                                                Impacto.</p>
                                            <p>Incrementar el contenido y la difusión de la biblioteca de Buenas
                                                Prácticas Sustentables en CCA.</p>
                                ...
                                <div class="col-md-6 col-sm-12 pl-sm-3 mt-3 mt-sm-0">
                                    ...
                                    <div class="card shadow-sm border-light mt-4">
                                        ...
                                        <div class="card-body">
                                            <h3 class="">Cultura</h3>
                                            <p>Hacer relevamientos económicos de las actividades culturales relacionadas
                                                a entidades de CAME con el objetivo de hacer un mapa económico cultural
                                                del país.</p>
                                            <p>Continuar creando Comisiones de Cultura en las provincias que todavía
                                                faltan.</p>
                                    ...
                                    <div class="card shadow-sm border-light mt-4">
                                        ...
                                        <div class="card-body">
                                            <h3 class="">Industria</h3>
                                            <p>Trabajar programas y políticas para la promoción de buenas prácticas
                                                sustentables en la industria.</p>
                                            <p>Impulsar el desarrollo del concepto de economía circular en las pymes
                                                industriales.</p>
                                            <p>Generar espacios de vinculación para proveedores multisectoriales.</p>
                                            <p>Visibilizar problemáticas de insumos importados.</p>
                                            <p>Participar en la Jornada para el Desarrollo Minero Argentino.</p>
                                            <p>Planificar reuniones regionales sectoriales.</p>
                                            <p>Desarrollar actividades en el marco del convenio con INTI.</p>
                                    ...
                                    <div class="card shadow-sm border-light mt-4">
                                        ...
                                        <div class="card-body">
                                            <h3 class="">Jóvenes</h3>
                                            <p>Impulsar y potenciar a las comisiones locales que integran la red federal
                                                de CAME Joven.</p>
                                            <p>Crear una Agenda Nacional de reuniones y actividades para los grupos de
                                                jóvenes empresarios y emprendedores.</p>
                                            <p>Completar la Mesa Nacional de Jóvenes Empresarios de CAME con la
                                                totalidad de referentes provinciales.</p>
                                            <p>Impulsar una Ley de educación financiera y emprendedora para fomentar la
                                                creación de nuevas pymes.</p>
                                            <p>Establecer relaciones intersectoriales con instituciones nacionales e
                                                internacionales para fortalecer la comunidad de jóvenes empresarios y
                                                emprendedores.</p>
                                    ...
                                    <div class="card shadow-sm border-light mt-4">
                                        <img src="images/logos/mujeres@4x.png" alt="Mujeres" class="card-img-top">
                                        <div class="card-body">
                                            <h3 class="">Mujeres</h3>
                                            <p>Participar del Encuentro Suprarregional de Mujeres en Córdoba.</p>
                                            <p>Otorgar la distinción Mujeres Empresarias 2023.</p>
                                            <p>Generar el Índice de Participación de la Mujer en las pymes (IPAMUP)
                                                2023.</p>
                                            <p>Realizar el Programa de formación She Trades Latam & ecomConnect:
                                                Empoderando a mujeres en e-commerce.</p>
                                            <p>Articular con entidades para seguir equipando y fortaleciendo la
                                                participación de mujeres en las exportaciones y en el ámbito STEAM.</p>


                                        </div>
                                    </div>
                                    <div class="card shadow-sm border-light mt-4">
                                        <img src="images/logos/turismo@4x.png" alt="Turismo" class="card-img-top">
                                        <div class="card-body">
                                            <h3 class="">Turismo</h3>
                                            <p>Realizar encuentros virtuales y presenciales de triple impacto para el
                                                sector turismo.</p>
                                            <p>Continuar con la identificación de actores y el fortalecimiento de
                                                alianzas.</p>
                                        </div>
                                    </div>
                                </div>
